...
import google from "../../../images/icon/GoogleIcon.png";
...
export const Login = () => {
    ...
    return (
        <>
                ...
                <div className="container">
                    <form onSubmit={handleSubmit(handleSignUp)}>
                        <p className="text-danger">
                            * Your password must be at least six characters long and must have at least one number
                        </p>
                        ...
                        <div className="inputBox">
                            ...
                            {errors.confirmPassword && (
                                <span className="text-danger">Please confirm your password before submitting</span>
                            )}
                        </div>
            ...
            {user.success && <p className="text-success">Account Created successfully, you can now login</p>}
        </>
    );
};
